...
class profile_view_body extends StatelessWidget {
  const profile_view_body({super.key, });
    ...
    return Padding(
      ...
      if (state is GetProfileDataFaluire) {
        ...
        builder: (context, state) {
          return state is GetProfileDataLoading?const CustomShimmerCategory():
            CustomProfileBuilder(model: context.read<ProfileCubit>().listProfileData[0],);
